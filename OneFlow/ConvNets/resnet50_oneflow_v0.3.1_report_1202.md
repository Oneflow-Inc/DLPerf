...
本报告总结了OneFlow v0.3.1 的ResNet50-V1.5 混合精度情况下dynamic loss scale的评测结果。
...
全部日志可以点击[rn50_dls_fp16_256_logs.zip](https://oneflow-public.oss-cn-beijing.aliyuncs.com/oneflow_test_log/oneflow_0.3.1/rn50_dls_fp16_256_logs.zip)获取。
