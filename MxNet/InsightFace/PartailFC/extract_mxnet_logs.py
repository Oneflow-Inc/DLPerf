...
parser.add_argument("--log_dir", type=str, default="./logs/mxnet/partial_fc", required=True)
...
def extract_info_from_file(log_file, result_dict, speed_dict):
    ...
    with open(log_file) as f:
        ...
        speeds = list()
        for line in lines:
            if "Rank:" in line and "Total:" in line:
                p1 = re.compile(r'Total:(\d+\.\d+) it/sec', re.S)
