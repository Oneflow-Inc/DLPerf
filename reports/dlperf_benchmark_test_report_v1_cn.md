...
| [PaddlePaddle](https://github.com/PaddlePaddle/Paddle/tree/v1.8.3) | 1.8.3.post107   | -                                       | [PaddleCV](https://github.com/PaddlePaddle/models/tree/release/1.8/PaddleCV/image_classification) | official / with DALI |
...
| node num | device num | [OneFlow](../OneFlow) | [NGC<br>TensorFlow 1.x](../NVIDIADeepLearningExamples/TensorFlow/Classification/ConvNets/resnet50v1.5) | [NGC<br>PyTorch](../NVIDIADeepLearningExamples/PyTorch/resnet50v1.5) | [NGC<br>MXNet](../NVIDIADeepLearningExamples/MxNet/Classification/RN50v1.5) | [PyTorch](../PyTorch/resnet50v1.5) | [PaddlePaddle](../PaddlePaddle/resnet50v1.5) | [TensorFlow 2.x](../TensorFlow/resnet50v1.5) |
| -------- | ---------- | --------------------- | ------------------------------------------------------------ | ------------------------------------------------------------ | ------------------------------------------------------------ | ---------------------------------- | -------------------------------------------- | -------------------------------------------- |
...
| node num | device num | [OneFlow](../OneFlow) | [NGC<br>TensorFlow 1.x<br>bsz=224](../NVIDIADeepLearningExamples/TensorFlow/Classification/ConvNets/resnet50v1.5) | [NGC<br>TensorFlow 1.x<br>w/XLA<br>bsz=224](../NVIDIADeepLearningExamples/TensorFlow/Classification/ConvNets/resnet50v1.5) | [NGC<br>PyTorch](../NVIDIADeepLearningExamples/PyTorch/resnet50v1.5) | [NGC<br>MXNet](../NVIDIADeepLearningExamples/MxNet/Classification/RN50v1.5) | [PaddlePaddle<br>bsz=224](../PaddlePaddle/resnet50v1.5) | [PaddlePaddle<br>w/DALI<br>bsz=196](../PaddlePaddle/resnet50v1.5)<sup>[1]</sup> | [TensorFlow 2.x](../TensorFlow/resnet50v1.5) |
| -------- | ---------- | --------------------- | ------------------------------------------------------------ | ------------------------------------------------------------ | ------------------------------------------------------------ | ------------------------------------------------------------ | ------------------------------------------------------- | ------------------------------------------------------------ | -------------------------------------------- |
| 1        | 1          | 1472.72               | 945.18                                                       | 1198.55                                                      | 802.9                                                        | 1393.87                                                      | 1034.64                                                 | 887.17                                                       | 1075.27                                      |
| 1        | 8          | 10629.32              | 6903.42                                                      | 8588.45                                                      | 6154.66                                                      | 9621.31                                                      | 4380.66                                                 | 6862.17                                                      | 6898.00                                      |
| 2        | 16         | 17920.40              | 12021.09                                                     | 14931.03                                                     | 11991.94                                                     | 16219.03                                                     | 6358.43                                                 | 6018.46                                                      | 9870.15                                      |
| 4        | 32         | 33141.02              | 24734.22                                                     | 29171.69                                                     | 22551.16                                                     | 30713.68                                                     | 10633.22                                                | 11617.57                                                     | 19314.31                                     |

注：

- 其中NGC TensorFlow 1.x 和 PaddlePaddle 的batch size = 224，因为batch size = 256会遇到OOM（out of memory）, PaddlePaddle w/DALI 一列的batch size = 196，因为DALI会占用一些GPU显存导致batch size = 224也会OOM。

- [1] 表格中的PaddlePaddle一列是Paddle原生框架在没有DALI的情况下的吞吐率。PaddlePaddle官方说明了使用[DALI-paddle](https://github.com/PaddlePaddle/models/tree/release/1.8/PaddleCV/image_classification#dali预处理)插件可以提升性能。我们安装DALI之后PaddlePaddle单机性能有提升，但是多机性能表现依然较差，见**PaddlePaddle w/DALI**一列。由于PaddlePaddle的官方提供的4机32卡的吞吐率：[28594 imgs/s](https://github.com/PaddlePaddle/models/tree/release/1.8/PaddleCV/image_classification#混合精度训练)是在V100 **32G**的显卡上测试的，且测试使用的是PaddlePaddle（w/DALI）的内部镜像，未公开，所以我们的测试结果暂时无法复现其官方数据。如果有人可以帮助我们提升Paddle的测试结果，请联系我们。 
