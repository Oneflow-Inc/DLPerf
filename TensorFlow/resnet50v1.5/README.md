...
fp16混合精度条件下，默认测试的batch_size=256，可以修改two_node_gpu_fp16.yaml的line:20指定其他batch size大小。
...
fp16混合精度条件下，默认测试的batch_size=256，可以修改multi_node_gpu_fp16.yaml的line:21指定其他batch size大小。
