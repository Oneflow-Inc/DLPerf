...
if  [ "$DTYPE" == "fp16" ] ; then
  config_file=configs/examples/resnet/imagenet/two_node_gpu_fp16.yaml
else
  config_file=configs/examples/resnet/imagenet/two_node_gpu.yaml
fi
