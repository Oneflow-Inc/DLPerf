...
CHECKPOINT_PATH=/data/megatron_lm_output
rm -rf /data/megatron_lm_output/*
M_P=${1:-1}
P_P=${2:-1}
...
LOGFILE=./megatron_lm_model_${NNODES}n${GPUS_PER_NODE}g_dp${D_P}_mp${M_P}_pp${P_P}_mbs${MICRO_BATCH_SIZE}_gbs${GLOABAL_BATCH_SIZE}_layers${NUM_LAYERS}_pretrain_${NODE_RANK}.log
